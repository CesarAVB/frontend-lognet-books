...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-12 bg-amber-500 border-t border-amber-600 text-white">
      ...
      <div className="border-t border-amber-600 py-4">
        <div className="container mx-auto px-4 text-sm text-amber-50 text-center">© 2026 <a href="https://lognetbr.com.br/" target="_blank" rel="noreferrer" className="text-amber-50/95 hover:text-white font-semibold">BRLognet</a>. Todos os direitos reservados.</div>
      </div>
    </footer>
  );
};
